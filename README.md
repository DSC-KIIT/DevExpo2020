...
Make sure you have the `gatsby-cli` installed, you and install it using `npm i -g gatsby-cli`

* Run `npm install` to install all the dependencies
* Run `gatsby develop` in the project folder. Your site is now running at `http://localhost:8000`
* Run `gatsby build` to build the static assets in the `public/` folder 
